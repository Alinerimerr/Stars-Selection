...
label prato2:
    ...
    if aceitavel:
        nh "UUUHUUUUU! Nós vencemos!"
        Sra "Com licença, srta.Nádia? Sou eu quem anuncia as coisas aqui."
        nsm "Opss, foi mal."
        Srh "Senhoras e senhores, eu declaro Moonie e Nádia as vencedoras de hoje!"
        "Confetes são lançados ao ar em comemoração."
        Srn "Meus parabéns, garotas!"
        nh "Ha ha! Agora, sim! Nós vencemos!"
        ...
        nsm "Obrigada, obrigada."
        "Vejo Linne discutindo com Junie ao fundo..."
        nsm "Mas até que, tipo... Cê foi bem."
        la "Sr.Star, eu tenho uma objeção."
        Srsu "Hm? Qual o problema, querida?"
        la "Acredito que essa competição foi injusta."
        la "Nádia claramente tem certa vantagem em culinária."
        Sra "E... Qual o problema?"
        # ela nao aceita perder
        la "É que..."
        li "A competição avaliou uma habilidade muito específica."
        li "É como avaliar a habilidade de um peixe subir em árvores..."
        li "Totalmente injunto."
        ri "É verdade. Eu concordo."
        li "Nem estamos treinando para isso, não é Juni?"
        jnv "Hm..."
        Srn "Ora, srta.Linne... Não vejo o motivo de sua preocupação."
        Sra "Afinal, isso é apenas uma brincadeira."
        la "..."
        Srh "Mas se isso incomoda tanto, te recomendo começar um curso de culinária!"
        nh "Ha! Chuuupaaa!"
        rn "..."
        Srn "Bem, isso é tuuuuudo por hoje!"
        Srn "Mas não percam, logo voltaremos com muito mais!"
        Srh "Uma ótima noite à todos e até mais!"
        jump cap1_7
    else:
        p "{i}!!!{i}"
        p "{i}O-O que...?{/i}"
        ...
        lh "Vencemos!"
        Srh "Ha ha, sim!"
        Srh "As vencedoras são Linne e Juni!"
        Srh "Meus parabéns, meninas!"
        "Confetes são lançados ao ar em comemoração."
        # elaborar comemoracao
        nsr "Espera aí um instante..."
        nsr "Você quase desmaiou provando aquele prato..."
        na "E mesmo assim deu a MAIOR NOTA?!"
        #"Nádia finalmente libera sua raiva."
        ri "Eu não estava quase desmaiando..."
        rc "Estava apenas... Saboreando o ingrediente especial da Juni!"
        rc "Sabe ele deu um sabor..."
        #"Roko procura por palavras."
        rn "Muito..."
        rnv "Huh..."
        rnv "..."
        rc "Único!"
        rc "Por isso achei que elas mereceram essa nota."
        na "Escuta aqui, sua-"
        ln "Calma, Nádia. Não há motivos para ficar irritada."
        lh "É só uma brincadeira..."
        #Srn "Exatamente. Vocês não sairam prejudicadas."
        na "Grrr!"
        "Ela vira as costas e sai batendo os pés."
    
        p "{i}É melhor eu conversar com ela.{/i}"
        m "Nádia, espera!"
        ...
        nsr "Argh! O que foi agora?!"
        nsr "Será que não posso ter um minuto de paz!??"
        ...
        menu(nvl=True):
            "Você não devia reagir assim":
                ...
                nsr "Isso... não é algo fácil de controlar e você sabe disso!"
                nsr "Afinal, aquilo foi muito pessoal."
                m "..."
                m "Mas se você continuar assim..."
                m "Quem sairá prejudicada será você!"
                nsr "... Não preciso da sua preocupação."
            ...
            "O julgamento está errado.":
                ...
                m "Ela-"
                na "Tem algo pessoal contra nós? Sim. Eu percebi!"
                na "Ela deve achar que a gente é algum tipo se seres primitivos! Por isso fez aquilo!"
                nsr "Porque não se manifestou naquela hora? Você também fazia parte da equipe."
                m "..."
                p "{i}Mas que situação complicada...{/i}"
                $ roko -= 3
        ...
        rc "Ora se não é a pavio curto e companhia!"
        rc "Espero que tenha esfriado a cabeça após aquele pequeno show."
        "O comentário incomoda não apenas Nádia, mas também Juni."
        na "Você que dá um julgamento totalmente inconsistente e eu saio como louca?!"
        la "Ela não disse isso!"
        ln "Não há motivos para brigar, meninas!"
        ln "Aquilo não era importante-"
        ja "Quem pensa que é..."
        ja "Quem você pensa que é para dar apelidos para os outros, Roko!"
        #"Surpresas, encaramos Juni."
        rsu "!"
        jnv "Err... Quero dizer..."
        jnv "E-essa não é uma atitude... Muito legal..."
        nn "Concordo plenamente."
        rsu "..."
        ri "Te dou 0.1 ponto a mais e é assim que me agradece?"
        ra "Deveria ter avaliado aquela porcaria como um completo zero!"
        # de qual lado ficar?
        la "Agora já chega!"
        li "Isso está indo longe demais!"
        li "Não podemos nos esquecer..."
        li "Que no final somos todas colegas e-"
        nsr "Cansei dessa conversa fiada!"
        nsr "Tô indo pro meu quarto. Uma boa noite pra vocês."
        "Nádia segue em direção aos dormitórios."
        la "Bem... Vamos deixar ela esfriar a cabeça."
        li "Vocês não sabem do que ela é capaz quando está com muita raiva..."
        rn "Hã?! Como assim?"
        li "Acreditem em mim... Eu a conheço há muito tempo."
        m "Conhece?"
        li "..."
...
label cap1_7:
    ...
    p "{i}Finalmente, tomei um banho e estou pronta para dormir.{/i}"
    p "{i}Caramba, estou exausta!{/i}"
    p "{i}???{/i}"
    "Enquanto me dirigia ao meu quarto, escuto uma voz vinda do quarto fechado ao lado..."
    ra "... Eu já não aguento mais!"
    p "{i}Essa é Roko...{/i}"
    "Me aproximo da porta para ouvir melhor."
    ri "Estou sofrendo uma pressão enorme para treinar duro..."
    ra "Todas aqui são grosseiras... não me tratam com o mínimo de atenção e respeito que mereço."
    ri "E pra piorar eles me obrigam a usar esse shampoo barato!"
    ra "Ai, isso não é justo! Não era pra ser tão difícil assim!"
    "Escuto ela chorar lá dentro."
    rs "Eu tinha certeza de que daria conta..."
    p "..."
    p "{i}E-Eu gostaria de ajudar... Mas acho que seria muita intromissão minha.{/i}"
    p "{i}Talvez eu converse com ela sobre isso mais tarde.{/i}"
