...
label cap2_2:
    ...
    nn "Finalmente, é hora de encher o buchinho!"
    nn "Opa, tô vendo que hoje tem filé de frango."
    "Todas nos sentamos à mesa."
    nn "Mal posso esperar pra provar."
    "Ela prova a refeição."
    nn "!!!"
    nn "Aí, esse filé de frango tá seco e duro!"
    nn "Pensei que teria uma refeição decente nesse lugar!"
    ...
    nn "Que chilique, nada! Só falei o que eu achei, idiota!"
    ...
    menu(nvl=True):
        ...
        "Não sair.":
            ...
            nn "Grrr! Eu odeio aquela falsa!"
            nn "E quela vagabunda rica-"
            m "C-Calma, por favor!"
            m "Você precisa se acalmar!"
            j "E-Eu ainda não terminei de comer..."
            nn "Ah... Foi mal."
            nn "Eu não queria ter causado tudo isso..."
            "..."
            "Ficamos em silêncio por um tempo."
            nn "Nossa, que climão..."
            nn "Já sei! Eu me lembro de ter visto uma caixa de docinhos em algum armário."
            nn "Podemos pegar unzinho e-"
            j "U-Uma caixa de doces? vermelha e pequena?"
            nn "Sim... Por que?"
            j "A-Acho que acabaram os doces..."
            nn "Você comeu tudo, garota?!"
            j "Me d-desculpa..."
            nn "*suspiro*"
    ...
    m "Oi, Nádia."
    nn "E aí? Vai treinar agora?"
    m "Sim... Se importa?"
    nn "Nop. Fica a vontade."
            ...
            "Foi da Roko.":
                ...
                menu(nvl=True):
                    ...
                    "Você é muito chata.":
                        ...
                        $ nadia -= 5
            "...":
                nn "Mal posso esperar pra ficar bem rica..."
                nn "Aí eu vou poder comprar todas as coisas que sempre quis, tipo roupas como essa."
                nn "E vou poder pagar as dívidas da família..."
                nn "Seria tão bom..."

    nn "Bom, chega de descanso!"
    nn "Posso me juntar a você nessa coreografia, senhorita?"
