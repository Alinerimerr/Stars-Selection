label prologo1_i:
    ...
    jnv "Certo, bem… Meu nome é Junnie e e-eu realmente quero conseguir debutar…"
    jh "Conto com o apoio de todos vocês!"
...
label prologo2:
    ...
    "Algumas decorações pontuam a personalidade e enquanto as mobílias são relativamente neutras."
    "Daqui, é visível um corredor que dá para os quartos."
    "Parece com aqueles conceitos minimalistas de simplicidade, mas no final é só para ficarem mais caros."
    # achei melhor a protagonista ter uma opinião propria aq
    p"{i}Apesar de diferente, achei o espaço até que bem agradável.{/i}"
    p"{i}Não parece uma casa, e temo que a tensão ao logo do programa não facilite.{/i}"
    ra "Ah... Eh aqui que nós todas vamos ficar?"
    "Roko olha ao redor com uma expressão meio... enojada."
    la "Ora, Roko! Não faça essa cara!"
    la "A equipe deu tudo para que o ambiente fosse o melhor possível!"
    la "É muito rude da sua parte exigir isso."
    ns "Ainda bem que não vamos precisar dividir os quartos..."
    ra "O que?!"
    nn "Nada, não."
    jn "A decoração também é muito bem elaborada..."
    jh "Eu achei uma graça!"
    nsm "A cozinha parece ótima também..."
    nsm "Será que podemos fazer alguma coisa aqui?"
    m "Ninguém disse que não podíamos, né?"
    nsm "É verdade!"
    nsr "Hmm... Como você se chama mesmo?"
    nsm "Luna ou algo do tipo, né?"
    "{i}Como... Como ela errou completamente o nome!?{/i}"
    m "É Moonie, na verdade."
    m "Mas podem me chamar de Moon, se quiserem."
    jh "Aaah! achei um apelido muito fofinho!"
    nsm "E é bem mais simples lembrar."   
    nn "Do que tava falando mesmo?... Ah, é!"
    nsm "Dá fazer muita coisa legal aqui."
    nsm "O que acham?"
    ...
    menu(nvl=True):
        ...
        "Não parece grande coisa.":
            ...
            la "Exatamente!"
            la "Não vamos ter tempo para essas coisas."
            "Nádia suspira beeem alto."

    rn "De qualquer forma..."
    #"Seu tom de voz se torna mais agressivo."
    ra "Não irei ingerir nada que vocês prepararem!"  
    nsr "!!!"
    #r "Não é nada pessoal..."
    rnv "É q-que eu costumo comer apenas pratos profissionais..."
    rnv "N-não é nada pessoal, endentem?"
    na "Na verdade pareceu bem pessoal, sim!"  
    jnv "humm... Bem..."
    jn "Melhor nós descansarmos agora."
    jn "Hoje foi um dia cheio e amanhã temos muito o que fazer."
...
label fimprologo:
    ...
    "Entro em meu quarto e observo ao redor."
    "Existem menos decorações, mas há uma escrivaninha, uma cama e uma cômoda."
    "E um armário bem pequeno..."
    "{i}Bem, grande parte serão apenas roupas de performance e treino escolhidas por estilistas, afinal.{/i}"
